...
---
Hello in the document presented here is the first homework in the "Machine Learning and Applications for Biological Data Analysis" cross.

The homework deals with Exploratory Data Analysis ("EDA") on the "world happiness report 2005-2020" data set.
